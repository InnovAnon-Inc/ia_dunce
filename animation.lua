-- ia_dunce/animation.lua

ia_dunce.animation_frames = {
    STAND     = { x =   0, y =  79, },
    LAY       = { x = 162, y = 166, },
    WALK      = { x = 168, y = 187, },
    MINE      = { x = 189, y = 198, },
...
-- @param state The string key from ia_dunce.animation_frames (e.g., "WALK")
-- @param speed Animation speed (default 30)
-- @param loop Whether the animation should repeat (default true)
function ia_dunce.set_animation(self, state, speed, loop)
	--minetest.log('ia_dunce.set_animation()')
    local frames = ia_dunce.animation_frames[state]
    ...
    self.object:set_animation(frames, speed or 30, 0, loop)
end
