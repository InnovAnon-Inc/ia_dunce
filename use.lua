...
function ia_dunce.use(self, pos)
	minetest.log('ia_dunce.use()')
    ...
    if not def or not def.on_use then
        ...
        -- We could fallback to ia_dunce.place(self, pos) here if we wanted.
        return false
    end
    ...
    local pointed_thing = ia_dunce.get_pointed_node(pos)
    ...
    -- TODO
    -- 4. Feedback
    --self.object:set_animation({x = 160, y = 200}, 30, 0, true) -- Interaction/Mine animation
